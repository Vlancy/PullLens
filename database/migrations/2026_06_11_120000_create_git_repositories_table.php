...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('git_repositories', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('webhook_hook_id')->nullable();
            ...
            $table->boolean('auto_enhance_pr_title')->default(false);
            ...
            $table->string('review_tone', 20)->default(ReviewTone::Professional->value);
